...
static void init_array(int ni, int nj, int nk, double * alpha, double * beta, double C[(2000+0)][(2000+0)], double A[(2000+0)][(2000+0)], double B[(2000+0)][(2000+0)])
{
	int i, j;
	( * alpha)=32412;
	( * beta)=2123;
...
*/
static void print_array(int ni, int nj, double C[(2000+0)][(2000+0)])
{
	int i, j;
	for (i=0; i<ni; i ++ )
	{
