...
/*By default it is compiled with time report*/
#ifndef POLYBENCH_TIME
...
/* Array declaration type. to avoid malloc*/
...
/*  Use non parametric loop bound*/
# ifndef POLYBENCH_USE_SCALAR_LB
/* default: */
...
/*If MPI is defined add if(rank==0) condition - so that master node only do the instrumentation*/
#ifdef MPI
# define MPIPAR  if (rank == 0)
#else
#define MPIPAR
#endif
