...
/*variables for comm timer*/
double mpipar_comm_t_end, mpipar_comm_t_start;
double mpipar_comm_t_total =0;
...
/*start comm time - of a mpi parallel loop*/
void mpipar_comm_timer_start()
{
   mpipar_comm_t_start = rtclock();

}

/*stop comm time of a parallel loop, then add to the mpipar_comm_t_total*/

void mpipar_comm_timer_stop()
{

  mpipar_comm_t_end = rtclock();
  mpipar_comm_t_total+=(mpipar_comm_t_end-mpipar_comm_t_start);
...
/*calculate and print the comm overhead*/
void mpipar_comm_overhead_print()
{
	double total_execution_time,comm_overhead;
	total_execution_time = polybench_t_end - polybench_t_start;
	comm_overhead = (mpipar_comm_t_total/total_execution_time)*100; //percentage
